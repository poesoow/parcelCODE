<template>
  ...
  <div :class="themecolor[theme] && themecolor[theme].back"  class="p-5 text-black text-base md:text-xl xl:text-2xl flex justify-between">
    <h3 class="font-extrabold">국내외 택배 조회서비스</h3>
    <div class="">
      <span>테마 : {{ theme }} </span>
      <button class="mx-1 md:mx-2 xl:mx-3" @click="theme = 'default'">기본</button>
      <button class="mx-1 md:mx-2 xl:mx-3" @click="theme = 'blue'">블루</button>
      <button class="mx-1 md:mx-2 xl:mx-3" @click="theme = 'green'">그린</button>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      themecolor: {
        "default" :{
          "back" : "bg-slate-100", "hover": "hover:bg-slate-500", "active": "bg-slate-400", "text": "text-black"
        },
        "blue": {
          "back": "bg-blue-100", "hover": "hover:bg-blue-500", "active": "bg-blue-400", "text": "text-blue"
        },
        "green": {
          "back": "bg-green-100", "hover": "hover:bg-green-500", "active": "bg-green-400", "text": "text-green"
        }
      }
    }
  },
